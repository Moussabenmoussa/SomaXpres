...
class AIAgent:
    ...
    def think_and_speak(self, user_input, history, product_context, merchant_rules, persona="amine", input_type="text"):
        ...
        - ممنوع منعا باتا تأكيد الطلب بدون ان تكون هذه العناصر كلها: رقم الهاتف و العنوان الكامل الولاية و المدينة  و الاسم الكامل و رقم الهاتف طلب بدونها لا يتم تأكيد الطلب .
        ...
        4. **الإغلاق:**
         ...
         تكلم بالدارجة الجزائرية فقط. كن حازماً في طلب الرقم و العنوان الكامل الولاية و المدينة  و الاسم الكامل و رقم الهاتف طلب بدونها لا يتم تأكيد الطلب .
        """
